package com.kuang.aspect;

/*
 *@Author WN
 *@date 2020/4/20 18:12
 */
import com.kuang.DynamicDataSourceConfiguration.configuration.DynamicDataSourceContextHolder;
...
public class DynamicDataSourceAspect {
    ...
    @Pointcut("execution(* com.kuang.service..*(..))")
